...
CSV_PATH = os.path.join("MAPPO", "checkpoints", "episode_rewards.csv")
COMP_CSV_PATH = os.path.join("MAPPO", "checkpoints", "episode_reward_components.csv")
EVAL_CSV_PATH = os.path.join("MAPPO", "checkpoints", "eval_metrics.csv")
OUT_PATH = os.path.join("MAPPO", "checkpoints", "reward_curve.png")
OUT_COMPONENT_PATH = os.path.join("MAPPO", "checkpoints", "reward_components_curve.png")
OUT_EVAL_PATH = os.path.join("MAPPO", "checkpoints", "eval_metrics_curve.png")
