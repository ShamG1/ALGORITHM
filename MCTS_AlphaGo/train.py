...
def main():
    ...
    parser.add_argument('--config', type=str, default='MCTS_AlphaGo/train_config.yaml', help='Path to YAML configuration file')
    ...
    trainer = MCTSTrainer(
        ...
        save_dir=str(config.get('train', {}).get('save_dir', 'MCTS_AlphaGo/checkpoints')),
