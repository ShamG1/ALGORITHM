    ...
    try:
        ...
        if _WORKER_CACHE["env"] is None:
            ...
            _WORKER_CACHE["env"] = IntersectionEnv({
                ...
                'fast_mode': True,    # enable fast physics mode
        ...
        if _WORKER_CACHE["mcts"] is None:
            ...
            mcts = MCTS(
                ...
                env_factory=None, # no factory, we inject the cached env manually
                all_networks=None, # no networks, use rule fallback
                agent_id=agent_id,
...
class MCTSTrainer:
    ...
    def __init__(
        ...
        def create_env_copy():
            ...
            This environment runs in fast/headless mode:
            - No pygame window
            - Graphics disabled for cars
            - Simplified geometric collision & no lidar ray-casting
            """
            try:
                ...
                env_copy = IntersectionEnv({
                    ...
                    'fast_mode': True,    # Enable headless fast-physics mode
                    'max_steps': max_steps_per_episode,
                    'respawn_enabled': respawn_enabled,
                    'reward_config': DEFAULT_REWARD_CONFIG['reward_config'],
                    'ego_routes': ego_routes_copy
    ...
    def train(self):
        ...
        while episode < self.max_episodes:
            ...
            # Create progress bar for this episode with accurate rate calculation
            ...
            print(
                ...
                f"Length: {episode_length:5d}{status_str}{rollout_info}"
            )
            ...
            # Periodic logging (averaged over log_frequency episodes)
