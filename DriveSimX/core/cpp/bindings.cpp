...
PYBIND11_MODULE(DRIVESIMX_ENV, m) {
    ...
    // Optimized NumPy interfaces (avoid Python .tolist() overhead)
    m.def("mcts_search_to_shm_np", &mcts_search_to_shm_np,
        py::arg("env"),
        py::arg("root_state"),
        py::arg("root_obs_seq"),
        py::arg("seq_len"),
    ...
    m.def("mcts_search_tcn_torchscript_seq_to_shm_np", &mcts_search_tcn_torchscript_seq_to_shm_np,
        py::arg("env"),
        py::arg("root_state"),
        py::arg("root_obs_seq"),
        py::arg("seq_len"),
